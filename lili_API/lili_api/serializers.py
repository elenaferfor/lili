...
class LibroSerializer(serializers.ModelSerializer):
    ...
    autores = serializers.PrimaryKeyRelatedField(required= False, queryset=Autor.objects.all(), many=True, write_only=True, default=None)
    autores_detalle = AutorNombreSerializer(source="autores", many=True, read_only=True)
    editorial = serializers.PrimaryKeyRelatedField(required=False, queryset=Editorial.objects.all(), write_only=True, allow_null=True, allow_empty=True, default=None)
